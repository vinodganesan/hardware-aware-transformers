...
def add_checkpoint_args(parser):
    ...
    # fmt: off
    group.add_argument('--save-dir', metavar='DIR', default=None,
...
def add_generation_args(parser):
    ...
    group.add_argument('--profile_latency', action='store_true',
                        help='Profile the generation latency of each part')
    # fmt: on
    return group
